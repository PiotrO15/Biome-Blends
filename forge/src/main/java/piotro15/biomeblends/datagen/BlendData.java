...
public record BlendData(String name, ResourceKey<Biome> id, BlendType blendType, String model, LinkedHashMap<Either<Item, TagKey<Item>>, Integer> ingredients) {
    ...
    public static final List<BlendData> blends = List.of(
            ...
            BlendData.of("Birch Forest Blend", Biomes.BIRCH_FOREST, 0xFFFF3F, "fluffy_blend", BlendData.entry(Items.GRASS, 2), BlendData.entry(Items.BIRCH_SAPLING, 1)),
            ...
            BlendData.of("Old Growth Birch Forest Blend", Biomes.OLD_GROWTH_BIRCH_FOREST, 0x7DC875, "fluffy_blend", BlendData.entry(Items.BIRCH_SAPLING, 2), BlendData.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Plains Blend", Biomes.PLAINS, 0x91BD59, "bumpy_blend", BlendData.entry(Items.GRASS, 2), BlendData.entry(Items.WHEAT_SEEDS, 2)),
            ...
            BlendData.of("Savanna Blend", Biomes.SAVANNA, 0xBDB855, "bumpy_blend", BlendData.entry(Items.ACACIA_SAPLING, 1), BlendData.entry(Items.GRASS, 2)),
            BlendData.of("Savanna Plateau Blend", Biomes.SAVANNA_PLATEAU, 0xC9C76C, "bumpy_blend", BlendData.entry(Items.ACACIA_SAPLING, 2), BlendData.entry(Items.GRASS, 1)),
            ...
            BlendData.of("Sunflower Plains Blend", Biomes.SUNFLOWER_PLAINS, 0xA2D84F, "bumpy_blend", BlendData.entry(Items.SUNFLOWER, 2), BlendData.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Windswept Hills Blend", Biomes.WINDSWEPT_HILLS, 0x92A379, "bumpy_blend", BlendData.entry(Items.GRASS, 2), BlendData.entry(Items.SPRUCE_SAPLING, 1)),
    ...
    public static List<BlendData> biomesOPlentyBlends = List.of(
            ...
            BlendData.of("Grassland Blend", BOPBiomes.GRASSLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(Items.GRASS, 4)),
            BlendData.of("Gravel Beach Blend", BOPBiomes.GRAVEL_BEACH, 0x9E9E9E, "bumpy_blend", BlendData.entry(Items.GRAVEL, 4)),
            BlendData.of("Highland Blend", BOPBiomes.HIGHLAND, 0x7B8F59, "bumpy_blend", BlendData.entry(Items.MOSSY_COBBLESTONE, 1), BlendData.entry(Items.GRASS, 3)),
            ...
            BlendData.of("Jacaranda Glade Blend", BOPBiomes.JACARANDA_GLADE, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.JACARANDA_SAPLING, 1), BlendData.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Moor Blend", BOPBiomes.MOOR, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.VIOLET, 3), BlendData.entry(Items.GRASS, 1)),
            ...
            BlendData.of("Ominous Woods Blend", BOPBiomes.OMINOUS_WOODS, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.UMBRAN_SAPLING, 2), BlendData.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Scrubland Blend", BOPBiomes.SCRUBLAND, ColorType.CALCULATED, "bumpy_blend", BlendData.entry(BOPItems.WILDFLOWER, 2), BlendData.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Wasteland Steppe Blend", BOPBiomes.WASTELAND_STEPPE, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.DESERT_GRASS, 2), BlendData.entry(Items.GRASS, 2)),
    ...
    public static List<BlendData> biomesWeveGoneBlends = List.of(
            ...
            BlendData.of("Cypress Wetlands Blend", BWGBiomes.CYPRESS_WETLANDS, ColorType.CALCULATED, "bumpy_blend", BlendData.entry(BWGWood.CYPRESS.sapling().getItem(), 1), BlendData.entry(BWGBlocks.CATTAIL_SPROUT.get().asItem(), 3)),
            ...
            BlendData.of("Zelkova Forest Blend", BWGBiomes.ZELKOVA_FOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BWGWood.ZELKOVA.sapling().getItem(), 1), BlendData.entry(Items.GRASS, 2))
    );
