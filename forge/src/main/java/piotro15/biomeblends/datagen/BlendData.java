...
public record BlendData(String name, ResourceKey<Biome> id, BlendType blendType, String model, Map<Item, Integer> ingredients) {
    ...
    public static final List<BlendData> blends = List.of(
            ...
            BlendData.of("Birch Forest Blend", Biomes.BIRCH_FOREST, 0xFFFF3F, "fluffy_blend", Map.entry(Items.GRASS, 2), Map.entry(Items.BIRCH_SAPLING, 1)),
            ...
            BlendData.of("Old Growth Birch Forest Blend", Biomes.OLD_GROWTH_BIRCH_FOREST, 0x7DC875, "fluffy_blend", Map.entry(Items.BIRCH_SAPLING, 2), Map.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Plains Blend", Biomes.PLAINS, 0x91BD59, "bumpy_blend", Map.entry(Items.GRASS, 2), Map.entry(Items.WHEAT_SEEDS, 2)),
            BlendData.of("River Blend", Biomes.RIVER, 0x4D9CB5, "bumpy_blend", Map.entry(Items.CLAY_BALL, 2), Map.entry(Items.WATER_BUCKET, 1)),
            BlendData.of("Savanna Blend", Biomes.SAVANNA, 0xBDB855, "bumpy_blend", Map.entry(Items.ACACIA_SAPLING, 1), Map.entry(Items.GRASS, 2)),
            BlendData.of("Savanna Plateau Blend", Biomes.SAVANNA_PLATEAU, 0xC9C76C, "bumpy_blend", Map.entry(Items.ACACIA_SAPLING, 2), Map.entry(Items.GRASS, 1)),
            ...
            BlendData.of("Sunflower Plains Blend", Biomes.SUNFLOWER_PLAINS, 0xA2D84F, "bumpy_blend", Map.entry(Items.SUNFLOWER, 2), Map.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Windswept Hills Blend", Biomes.WINDSWEPT_HILLS, 0x92A379, "bumpy_blend", Map.entry(Items.GRASS, 2), Map.entry(Items.SPRUCE_SAPLING, 1)),
    ...
    public static List<BlendData> biomesOPlentyBlends = List.of(
            ...
            BlendData.of("Grassland Blend", BOPBiomes.GRASSLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.entry(Items.GRASS, 4)),
            BlendData.of("Gravel Beach Blend", BOPBiomes.GRAVEL_BEACH, 0x9E9E9E, "bumpy_blend", Map.entry(Items.GRAVEL, 4)),
            BlendData.of("Highland Blend", BOPBiomes.HIGHLAND, 0x7B8F59, "bumpy_blend", Map.entry(Items.MOSSY_COBBLESTONE, 1), Map.entry(Items.GRASS, 3)),
            ...
            BlendData.of("Jacaranda Glade Blend", BOPBiomes.JACARANDA_GLADE, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.entry(BOPItems.JACARANDA_SAPLING, 1), Map.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Moor Blend", BOPBiomes.MOOR, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.entry(BOPItems.VIOLET, 3), Map.entry(Items.GRASS, 1)),
            ...
            BlendData.of("Ominous Woods Blend", BOPBiomes.OMINOUS_WOODS, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.entry(BOPItems.UMBRAN_SAPLING, 2), Map.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Scrubland Blend", BOPBiomes.SCRUBLAND, ColorType.CALCULATED, "bumpy_blend", Map.entry(BOPItems.WILDFLOWER, 2), Map.entry(Items.GRASS, 2)),
            ...
            BlendData.of("Wasteland Steppe Blend", BOPBiomes.WASTELAND_STEPPE, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.entry(BOPItems.DESERT_GRASS, 2), Map.entry(Items.GRASS, 2)),
