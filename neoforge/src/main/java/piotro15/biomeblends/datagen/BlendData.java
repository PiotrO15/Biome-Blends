...
public record BlendData(String name, ResourceKey<Biome> id, BlendType blendType, LinkedHashMap<Either<Item, TagKey<Item>>, Integer> ingredients) {
    ...
    public static final List<BlendData> blends = List.of(
            ...
            BlendData.of("Dappled Forest Blend", Biomes.DAPPLED_FOREST, 0xdf6827, "fluffy_blend", BlendData.entry(Items.POPLAR_SAPLING, 2), BlendData.entry(Items.SHELF_MUSHROOM, 2)),
            ...
            BlendData.of("Pale Garden Blend", Biomes.PALE_GARDEN, 0x778272, "fluffy_blend", BlendData.entry(Items.PALE_OAK_SAPLING, 1), BlendData.entry(Items.PALE_MOSS_BLOCK, 3)),
            ...
            BlendData.of("Sulfur Caves Blend", Biomes.SULFUR_CAVES, 0xf2ec44, "rocky_blend", BlendData.entry(Items.SULFUR, 3)),
    ...
    public static List<BlendData> biomesOPlentyBlends = List.of(
            BlendData.of("Auroral Garden Blend", BOPBiomes.AURORAL_GARDEN, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.ICY_IRIS, 2), BlendData.entry(Items.SNOWBALL, 2)),
            ...
            BlendData.of("Bog Blend", BOPBiomes.BOG, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(Items.SWEET_BERRIES, 1), BlendData.entry(BOPItems.REED, 2)),
            ...
            BlendData.of("Dryland Blend", BOPBiomes.DRYLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(Items.LEAF_LITTER, 3), BlendData.entry(BOPItems.TINY_CACTUS, 2)),
            BlendData.of("Dune Beach Blend", BOPBiomes.DUNE_BEACH, 0xE8D1A3, "bumpy_blend", BlendData.entry(BOPItems.SEA_OATS, 2), BlendData.entry(BOPItems.DUNE_GRASS, 2)),
            ...
            BlendData.of("End Flats Blend", BOPBiomes.END_FLATS, 0xb1cdda, "bumpy_blend", BlendData.entry(Items.END_STONE, 2), BlendData.entry(Items.CUT_COPPER.waxed().weathered(), 2)),
            BlendData.of("End Reef Blend", BOPBiomes.END_REEF, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.WISPJELLY, 1), BlendData.entry(BOPItems.WHITE_SAND, 2)),
            ...
            BlendData.of("Erupting Inferno Blend", BOPBiomes.ERUPTING_INFERNO, 0xFF6B1A, "bumpy_blend", BlendData.entry(BOPItems.ORPIMENT, 2), BlendData.entry(Items.NETHERRACK, 2)),
            BlendData.of("Field Blend", BOPBiomes.FIELD, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.TALL_WHITE_LAVENDER, 2), BlendData.entry(BOPItems.PURPLE_WILDFLOWERS, 2)),
            ...
            BlendData.of("Floodplain Blend", BOPBiomes.FLOODPLAIN, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.WATERGRASS, 3), BlendData.entry(BOPItems.WATERLILY, 1)),
            ...
            BlendData.of("Highland Blend", BOPBiomes.HIGHLAND, 0x7B8F59, "bumpy_blend", BlendData.entry(Items.MOSSY_COBBLESTONE, 1), BlendData.entry(Items.BUSH, 3)),
            BlendData.of("Hot Springs Blend", BOPBiomes.HOT_SPRINGS, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.SPHALERITE, 1), BlendData.entry(Items.SULFUR, 1), BlendData.entry(BOPItems.ORPIMENT, 1), BlendData.entry(Items.CINNABAR, 1)),
            ...
            BlendData.of("Lush Desert Blend", BOPBiomes.LUSH_DESERT, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.ORANGE_SAND, 2), BlendData.entry(BOPItems.PALM_SAPLING, 1)),
            ...
            BlendData.of("Maple Woods Blend", BOPBiomes.MAPLE_WOODS, 0xB94A2E, "fluffy_blend", BlendData.entry(BOPItems.MAPLE_SAPLING, 2), BlendData.entry(BOPItems.MAPLE_LEAF_LITTER, 2)),
            ...
            BlendData.of("Mediterranean Forest Blend", BOPBiomes.MEDITERRANEAN_FOREST, ColorType.CALCULATED, "fluffy_blend", BlendData.entry(BOPItems.CYPRESS_SAPLING, 1), BlendData.entry(Items.BUSH, 2)),
            ...
            BlendData.of("Mystic Grove Blend", BOPBiomes.MYSTIC_GROVE, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.MAGIC_SAPLING, 1), BlendData.entry(BOPItems.CLOVER, 2)),
            ...
            BlendData.of("Ominous Woods Blend", BOPBiomes.OMINOUS_WOODS, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.UMBRAN_SAPLING, 2), BlendData.entry(Items.WITHER_ROSE, 2)),
            ...
            BlendData.of("Origin Valley Blend", BOPBiomes.ORIGIN_VALLEY, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.ORIGIN_OAK_SAPLING, 1), BlendData.entry(Items.DIRT, 2)),
            ...
            BlendData.of("Prairie Blend", BOPBiomes.PRAIRIE, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.GOLDENROD, 2), BlendData.entry(Items.WILDFLOWERS, 2)),
            BlendData.of("Pumpkin Patch Blend", BOPBiomes.PUMPKIN_PATCH, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.MAPLE_SAPLING, 1), BlendData.entry(Items.PUMPKIN, 3)),
            ...
            BlendData.of("Rocky Rainforest Blend", BOPBiomes.ROCKY_RAINFOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.SPROUT, 2), BlendData.entry(Items.TERRACOTTA, 2)),
            BlendData.of("Rocky Shrubland Blend", BOPBiomes.ROCKY_SHRUBLAND, ColorType.CALCULATED, "bumpy_blend", BlendData.entry(Items.BUSH, 2), BlendData.entry(Items.COBBLESTONE, 2)),
            BlendData.of("Scrubland Blend", BOPBiomes.SCRUBLAND, ColorType.CALCULATED, "bumpy_blend", BlendData.entry(BOPItems.PURPLE_WILDFLOWERS, 2), BlendData.entry(Items.DRY_SHORT_GRASS, 2)),
            BlendData.of("Seasonal Forest Blend", BOPBiomes.SEASONAL_FOREST, 0xd1b24a, "fluffy_blend", BlendData.entry(BOPItems.MAPLE_SAPLING, 2), BlendData.entry(Items.POPLAR_SAPLING, 1)),
            BlendData.of("Shrubland Blend", BOPBiomes.SHRUBLAND, ColorType.CALCULATED, "bumpy_blend", BlendData.entry(Items.BUSH, 1), BlendData.entry(Items.LILAC, 2)),
            ...
            BlendData.of("Snowy Maple Woods Blend", BOPBiomes.SNOWY_MAPLE_WOODS, 0xC97B56, "fluffy_blend", BlendData.entry(BOPItems.MAPLE_SAPLING, 1), BlendData.entry(Items.SNOWBALL, 2)),
            ...
            BlendData.of("Subtropics Blend", BOPBiomes.SUBTROPICS, ColorType.FOLIAGE_COLOR, "fluffy_blend", BlendData.entry(BOPItems.FLOWERING_OAK_SAPLING, 1), BlendData.entry(Items.TORCHFLOWER, 2)),
            ...
            BlendData.of("Tundra Blend", BOPBiomes.TUNDRA, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.TUNDRA_SHRUB, 2), BlendData.entry(Items.FERN, 2)),
            BlendData.of("Undergrowth Blend", BOPBiomes.UNDERGROWTH, 0x2E5D35, "bumpy_blend", BlendData.entry(BOPItems.DEAD_GRASS, 1), BlendData.entry(BOPItems.BRAMBLE, 2)),
            ...
            BlendData.of("Wasteland Steppe Blend", BOPBiomes.WASTELAND_STEPPE, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.DESERT_GRASS, 2), BlendData.entry(BOPItems.DEAD_GRASS, 2)),
            ...
            BlendData.of("Wintry Origin Valley Blend", BOPBiomes.WINTRY_ORIGIN_VALLEY, ColorType.FOLIAGE_COLOR, "bumpy_blend", BlendData.entry(BOPItems.ORIGIN_OAK_SAPLING, 1), BlendData.entry(Items.SNOWBALL, 3)),
...
//    );
    ...
    private static int findColorForBiome(ResourceKey<Biome> id, ColorType colorType) {
        String path = "data/" + id.identifier().getNamespace()
                + "/worldgen/biome/" + id.identifier().getPath() + ".json";
        ...
        try (InputStream is = BlendTypeProvider.class.getClassLoader().getResourceAsStream(path)) {
            ...
            switch (colorType) {
                ...
                case GRASS_COLOR -> {
                    if (effects.has("grass_color")) {
                        ...
                        System.out.println("Found grass color for " + id.identifier() + ": " + Integer.toHexString(color));
                        return color;
                    }
                }
                case WATER_COLOR -> {
                    if (effects.has("water_color")) {
                        ...
                        System.out.println("Found water color for " + id.identifier() + ": " + Integer.toHexString(color));
                        return color;
                    }
                }
                case CALCULATED -> {
                    if (json.has("temperature") && json.has("downfall")) {
                        ...
                        System.out.println("Calculated color for " + id.identifier() + ": " + color);
                        return color;
                    }
                }
            }
            ...
            throw new RuntimeException("Failed to read biome JSON for " + id.identifier(), e);
        }
    }
    ...
    public String getNamespace() {
        return id.identifier().getNamespace();
    }
}
