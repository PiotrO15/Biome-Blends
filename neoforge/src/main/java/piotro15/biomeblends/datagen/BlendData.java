...
public record BlendData(String name, ResourceKey<Biome> id, BlendType blendType, String model, LinkedHashMap<Item, Integer> ingredients) {
    ...
    public static List<BlendData> biomesOPlentyBlends = List.of(
            ...
            BlendData.of("Coniferous Forest Blend", BOPBiomes.CONIFEROUS_FOREST, 0xC96435, "fluffy_blend", Map.entry(BOPItems.FIR_SAPLING, 1), Map.entry(Items.FERN, 1)),
            BlendData.of("Crag Blend", BOPBiomes.CRAG, 0xC96435, "bumpy_blend", Map.entry(Items.MOSS_BLOCK, 2), Map.entry(Items.COBBLESTONE, 2)),
            BlendData.of("Crystalline Chasm Blend", BOPBiomes.CRYSTALLINE_CHASM, 0xC96435,"bumpy_blend", Map.entry(BOPItems.ROSE_QUARTZ_CHUNK, 2), Map.entry(Items.NETHERRACK, 2)),
            ...
            BlendData.of("Dune Beach Blend", BOPBiomes.DUNE_BEACH, 0xC96435, "bumpy_blend", Map.entry(BOPItems.SEA_OATS, 2), Map.entry(Items.SAND, 2)),
            ...
            BlendData.of("Erupting Inferno Blend", BOPBiomes.ERUPTING_INFERNO, 0xC96435, "bumpy_blend", Map.entry(BOPItems.BRIMSTONE, 2), Map.entry(Items.NETHERRACK, 2)),
            ...
            BlendData.of("Fir Clearing Blend", BOPBiomes.FIR_CLEARING, 0xC96435, "fluffy_blend", Map.entry(BOPItems.FIR_SAPLING, 1), Map.entry(BOPItems.TOADSTOOL, 2)),
            ...
            BlendData.of("Glowing Grotto Blend", BOPBiomes.GLOWING_GROTTO, 0xC96435, "rocky_blend", Map.entry(BOPItems.GLOWING_MOSS_BLOCK, 2), Map.entry(BOPItems.GLOWSHROOM, 1)),
            BlendData.of("Grassland Blend", BOPBiomes.GRASSLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.entry(Items.SHORT_GRASS, 4)),
            BlendData.of("Gravel Beach Blend", BOPBiomes.GRAVEL_BEACH, 0xC96435, "bumpy_blend", Map.entry(Items.GRAVEL, 4)),
            BlendData.of("Highland Blend", BOPBiomes.HIGHLAND, 0xC96435, "bumpy_blend", Map.entry(Items.MOSSY_COBBLESTONE, 1), Map.entry(Items.SHORT_GRASS, 3)),
            ...
            BlendData.of("Maple Woods Blend", BOPBiomes.MAPLE_WOODS, 0xC96435, "fluffy_blend", Map.entry(BOPItems.RED_MAPLE_SAPLING, 2), Map.entry(BOPItems.VIOLET, 1)),
            BlendData.of("Marsh Blend", BOPBiomes.MARSH, 0xC96435, "bumpy_blend", Map.entry(BOPItems.REED, 2), Map.entry(BOPItems.WATERGRASS, 2)),
            BlendData.of("Mediterranean Forest Blend", BOPBiomes.MEDITERRANEAN_FOREST, 0xC96435, "fluffy_blend", Map.entry(BOPItems.CYPRESS_SAPLING, 1), Map.entry(BOPItems.BUSH, 2)),
            ...
            BlendData.of("Rocky Shrubland Blend", BOPBiomes.ROCKY_SHRUBLAND, 0xC96435, "bumpy_blend", Map.entry(BOPItems.BUSH, 2), Map.entry(Items.COBBLESTONE, 2)),
            BlendData.of("Scrubland Blend", BOPBiomes.SCRUBLAND, 0xC96435, "bumpy_blend", Map.entry(BOPItems.WILDFLOWER, 2), Map.entry(Items.SHORT_GRASS, 2)),
            ...
            BlendData.of("Shrubland Blend", BOPBiomes.SHRUBLAND, 0xC96435, "bumpy_blend", Map.entry(BOPItems.BUSH, 1), Map.entry(Items.LILAC, 2)),
            ...
            BlendData.of("Snowy Coniferous Forest Blend", BOPBiomes.SNOWY_CONIFEROUS_FOREST, 0xC96435, "fluffy_blend", Map.entry(BOPItems.FIR_SAPLING, 1), Map.entry(Items.SNOWBALL, 2)),
            BlendData.of("Snowy Fir Clearing Blend", BOPBiomes.SNOWY_FIR_CLEARING, 0xC96435, "bumpy_blend", Map.entry(BOPItems.FIR_SAPLING, 1), Map.entry(Items.FERN, 1), Map.entry(Items.SNOWBALL, 2)),
            BlendData.of("Snowy Maple Woods Blend", BOPBiomes.SNOWY_MAPLE_WOODS, 0xC96435, "fluffy_blend", Map.entry(BOPItems.RED_MAPLE_SAPLING, 1), Map.entry(Items.SNOWBALL, 2)),
            BlendData.of("Spider Nest Blend", BOPBiomes.SPIDER_NEST, 0xC96435, "rocky_blend", Map.entry(BOPItems.WEBBING, 2), Map.entry(BOPItems.HANGING_COBWEB, 1)),
            BlendData.of("Tropics Blend", BOPBiomes.TROPICS, 0xC96435, "fluffy_blend", Map.entry(BOPItems.PALM_SAPLING, 1), Map.entry(BOPItems.BLUE_HYDRANGEA, 2)),
            ...
            BlendData.of("Undergrowth Blend", BOPBiomes.UNDERGROWTH, 0xC96435, "bumpy_blend", Map.entry(BOPItems.HELLBARK_SAPLING, 1), Map.entry(BOPItems.BRAMBLE, 2)),
            BlendData.of("Visceral Heap Blend", BOPBiomes.VISCERAL_HEAP, 0xC96435, "bumpy_blend", Map.entry(BOPItems.FLESH, 3)),
