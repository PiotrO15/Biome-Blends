...
public record BlendData(String name, ResourceKey<Biome> id, BlendType blendType, String model, Map<Item, Integer> ingredients) {
    ...
    public static List<BlendData> biomesOPlentyBlends = List.of(
            ...
            generatedColorBlendData("Forested Field Blend", BOPBiomes.FORESTED_FIELD, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(Items.SPRUCE_SAPLING, 1, BOPItems.SPROUT, 2)),
            generatedColorBlendData("Fungal Jungle Blend", BOPBiomes.FUNGAL_JUNGLE, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.TOADSTOOL, 2, Items.JUNGLE_SAPLING, 1)),
            defaultBlendData("Glowing Grotto Blend", BOPBiomes.GLOWING_GROTTO, 0xC96435, "rocky_blend", Map.of(BOPItems.GLOWING_MOSS_BLOCK, 2, BOPItems.GLOWSHROOM, 1)),
            generatedColorBlendData("Grassland Blend", BOPBiomes.GRASSLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(Items.SHORT_GRASS, 4)),
            defaultBlendData("Gravel Beach Blend", BOPBiomes.GRAVEL_BEACH, 0xC96435, "bumpy_blend", Map.of(Items.GRAVEL, 4)),
            defaultBlendData("Highland Blend", BOPBiomes.HIGHLAND, 0xC96435, "bumpy_blend", Map.of(Items.MOSSY_COBBLESTONE, 1, Items.SHORT_GRASS, 3)),
            generatedColorBlendData("Hot Springs Blend", BOPBiomes.HOT_SPRINGS, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.PINE_SAPLING, 1, BOPItems.THERMAL_CALCITE, 2)),
            generatedColorBlendData("Jacaranda Glade Blend", BOPBiomes.JACARANDA_GLADE, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.JACARANDA_SAPLING, 1, Items.SHORT_GRASS, 2)),
            generatedColorBlendData("Jade Cliffs Blend", BOPBiomes.JADE_CLIFFS, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.PINE_SAPLING, 1, Items.SPRUCE_SAPLING, 2)),
            generatedColorBlendData("Lavender Field Blend", BOPBiomes.LAVENDER_FIELD, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.LAVENDER, 3, BOPItems.JACARANDA_SAPLING, 1)),
            generatedColorBlendData("Lush Desert Blend", BOPBiomes.LUSH_DESERT, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.ORANGE_SAND, 2, Items.ACACIA_SAPLING, 1)),
            generatedColorBlendData("Lush Savanna Blend", BOPBiomes.LUSH_SAVANNA, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(Items.POPPY, 3, Items.ROSE_BUSH, 1)),
            defaultBlendData("Maple Woods Blend", BOPBiomes.MAPLE_WOODS, 0xC96435, "fluffy_blend", Map.of(BOPItems.RED_MAPLE_SAPLING, 2, BOPItems.VIOLET, 1)),
            defaultBlendData("Marsh Blend", BOPBiomes.MARSH, 0xC96435, "bumpy_blend", Map.of(BOPItems.REED, 2, BOPItems.WATERGRASS, 2)),
            defaultBlendData("Mediterranean Forest Blend", BOPBiomes.MEDITERRANEAN_FOREST, 0xC96435, "fluffy_blend", Map.of(BOPItems.CYPRESS_SAPLING, 1, BOPItems.BUSH, 2)),
            generatedColorBlendData("Moor Blend", BOPBiomes.MOOR, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.VIOLET, 3, Items.SHORT_GRASS, 1)),
            generatedColorBlendData("Muskeg Blend", BOPBiomes.MUSKEG, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(Items.MUD, 2, Items.SNOWBALL, 2)),
            generatedColorBlendData("Mystic Grove Blend", BOPBiomes.MYSTIC_GROVE, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.MAGIC_SAPLING, 1, BOPItems.BLUE_HYDRANGEA, 2)),
            generatedColorBlendData("Old Growth Dead Forest Blend", BOPBiomes.OLD_GROWTH_DEAD_FOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.DEAD_LOG, 2, Items.DEAD_BUSH, 1)),
            generatedColorBlendData("Old Growth Woodland Blend", BOPBiomes.OLD_GROWTH_WOODLAND, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.TOADSTOOL, 1, Items.OAK_SAPLING, 2)),
            generatedColorBlendData("Ominous Woods Blend", BOPBiomes.OMINOUS_WOODS, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.UMBRAN_SAPLING, 2, Items.SHORT_GRASS, 2)),
            generatedColorBlendData("Orchard Blend", BOPBiomes.ORCHARD, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.FLOWERING_OAK_SAPLING, 1, BOPItems.CLOVER, 3)),
            generatedColorBlendData("Origin Valley Blend", BOPBiomes.ORIGIN_VALLEY, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.ORIGIN_SAPLING, 1, Items.DIRT, 2)),
            generatedColorBlendData("Overgrown Greens Blend", BOPBiomes.OVERGROWN_GREENS, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.HIGH_GRASS, 3, BOPItems.HUGE_CLOVER_PETAL, 1)),
            generatedColorBlendData("Pasture Blend", BOPBiomes.PASTURE, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.BARLEY, 3)),
            generatedColorBlendData("Prairie Blend", BOPBiomes.PRAIRIE, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.GOLDENROD, 2, BOPItems.BARLEY, 2)),
            generatedColorBlendData("Pumpkin Patch Blend", BOPBiomes.PUMPKIN_PATCH, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.ORANGE_MAPLE_SAPLING, 1, Items.PUMPKIN, 3)),
            generatedColorBlendData("Rainforest Blend", BOPBiomes.RAINFOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.MAHOGANY_SAPLING, 1, Items.FERN, 2)),
            generatedColorBlendData("Redwood Forest Blend", BOPBiomes.REDWOOD_FOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.REDWOOD_SAPLING, 1, Items.FERN, 2)),
            generatedColorBlendData("Rocky Rainforest Blend", BOPBiomes.ROCKY_RAINFOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.MAHOGANY_SAPLING, 1, Items.TERRACOTTA, 2)),
            defaultBlendData("Rocky Shrubland Blend", BOPBiomes.ROCKY_SHRUBLAND, 0xC96435, "bumpy_blend", Map.of(BOPItems.BUSH, 2, Items.COBBLESTONE, 2)),
            defaultBlendData("Scrubland Blend", BOPBiomes.SCRUBLAND, 0xC96435, "bumpy_blend", Map.of(BOPItems.WILDFLOWER, 2, Items.SHORT_GRASS, 2)),
            generatedColorBlendData("Seasonal Forest Blend", BOPBiomes.SEASONAL_FOREST, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.YELLOW_MAPLE_SAPLING, 1, BOPItems.ORANGE_MAPLE_SAPLING, 1, BOPItems.RED_MAPLE_SAPLING, 1)),
            defaultBlendData("Shrubland Blend", BOPBiomes.SHRUBLAND, 0xC96435, "bumpy_blend", Map.of(BOPItems.BUSH, 1, Items.LILAC, 2)),
            generatedColorBlendData("Snowblossom Grove Blend", BOPBiomes.SNOWBLOSSOM_GROVE, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.SNOWBLOSSOM_SAPLING, 1, BOPItems.WHITE_PETALS, 2)),
            defaultBlendData("Snowy Coniferous Forest Blend", BOPBiomes.SNOWY_CONIFEROUS_FOREST, 0xC96435, "fluffy_blend", Map.of(BOPItems.FIR_SAPLING, 1, Items.SNOWBALL, 2)),
            defaultBlendData("Snowy Fir Clearing Blend", BOPBiomes.SNOWY_FIR_CLEARING, 0xC96435, "bumpy_blend", Map.of(BOPItems.FIR_SAPLING, 1, Items.FERN, 1, Items.SNOWBALL, 2)),
            defaultBlendData("Snowy Maple Woods Blend", BOPBiomes.SNOWY_MAPLE_WOODS, 0xC96435, "fluffy_blend", Map.of(BOPItems.RED_MAPLE_SAPLING, 1, Items.SNOWBALL, 2)),
            defaultBlendData("Spider Nest Blend", BOPBiomes.SPIDER_NEST, 0xC96435, "rocky_blend", Map.of(BOPItems.WEBBING, 2, BOPItems.HANGING_COBWEB, 1)),
            defaultBlendData("Tropics Blend", BOPBiomes.TROPICS, 0xC96435, "fluffy_blend", Map.of(BOPItems.PALM_SAPLING, 1, BOPItems.BLUE_HYDRANGEA, 2)),
            generatedColorBlendData("Tundra Blend", BOPBiomes.TUNDRA, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.RED_MAPLE_SAPLING, 1, Items.FERN, 2)),
            defaultBlendData("Undergrowth Blend", BOPBiomes.UNDERGROWTH, 0xC96435, "bumpy_blend", Map.of(BOPItems.HELLBARK_SAPLING, 1, BOPItems.BRAMBLE, 2)),
            defaultBlendData("Visceral Heap Blend", BOPBiomes.VISCERAL_HEAP, 0xC96435, "bumpy_blend", Map.of(BOPItems.FLESH, 3)),
            generatedColorBlendData("Volcanic Plains Blend", BOPBiomes.VOLCANIC_PLAINS, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.BLACK_SAND, 2, Items.FERN, 2)),
            generatedColorBlendData("Volcano Blend", BOPBiomes.VOLCANO, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.BLACK_SANDSTONE, 1, Items.BASALT, 2)),
            generatedColorBlendData("Wasteland Blend", BOPBiomes.WASTELAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.DRIED_SALT, 2, BOPItems.DEAD_LOG, 2)),
            generatedColorBlendData("Wasteland Steppe Blend", BOPBiomes.WASTELAND_STEPPE, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.DESERT_GRASS, 2, Items.SHORT_GRASS, 2)),
            generatedColorBlendData("Wetland Blend", BOPBiomes.WETLAND, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.WILLOW_SAPLING, 1, BOPItems.CATTAIL, 2)),
            generatedColorBlendData("Wintry Origin Valley Blend", BOPBiomes.WINTRY_ORIGIN_VALLEY, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.ORIGIN_SAPLING, 1, Items.SNOWBALL, 3)),
            generatedColorBlendData("Withered Abyss Blend", BOPBiomes.WITHERED_ABYSS, ColorType.FOLIAGE_COLOR, "bumpy_blend", Map.of(BOPItems.BLACKSTONE_BULB, 1, Items.BLACKSTONE, 2)),
            generatedColorBlendData("Woodland Blend", BOPBiomes.WOODLAND, ColorType.FOLIAGE_COLOR, "fluffy_blend", Map.of(BOPItems.TOADSTOOL, 1, Items.ROSE_BUSH, 2))
    );
