...
public record BlendData(String name, String id, BlendType blendType, String model, Map<Item, Integer> ingredients) {
    public static final List<BlendData> blends = List.of(
            ...
            defaultBlendData("Birch Forest Blend", "birch_forest", 0xFFFF3F, "fluffy_blend", Map.of(Items.SHORT_GRASS, 2, Items.BIRCH_SAPLING, 1)),
            ...
            defaultBlendData("Old Growth Birch Forest Blend", "old_growth_birch_forest", 0x7DC875, "fluffy_blend", Map.of(Items.BIRCH_SAPLING, 2, Items.SHORT_GRASS, 2)),
            ...
            defaultBlendData("Plains Blend", "plains", 0x91BD59, "bumpy_blend", Map.of(Items.SHORT_GRASS, 2, Items.WHEAT_SEEDS, 2)),
            defaultBlendData("River Blend", "river", 0x4D9CB5, "bumpy_blend", Map.of(Items.CLAY_BALL, 2, Items.WATER_BUCKET, 1)),
            defaultBlendData("Savanna Blend", "savanna", 0xBDB855, "bumpy_blend", Map.of(Items.ACACIA_SAPLING, 1, Items.SHORT_GRASS, 2)),
            defaultBlendData("Savanna Plateau Blend", "savanna_plateau", 0xC9C76C, "bumpy_blend", Map.of(Items.ACACIA_SAPLING, 2, Items.SHORT_GRASS, 1)),
            ...
            defaultBlendData("Sunflower Plains Blend", "sunflower_plains", 0xA2D84F, "bumpy_blend", Map.of(Items.SUNFLOWER, 2, Items.SHORT_GRASS, 2)),
            ...
            defaultBlendData("Windswept Hills Blend", "windswept_hills", 0x92A379, "bumpy_blend", Map.of(Items.SHORT_GRASS, 2, Items.SPRUCE_SAPLING, 1)),
