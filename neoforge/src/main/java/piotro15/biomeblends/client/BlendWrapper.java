...
//                Identifier blendType = stack.has(BiomeBlendsDataComponents.BLEND_TYPE)
//                        ? stack.get(BiomeBlendsDataComponents.BLEND_TYPE)
//                        : null;
//
//                if (blendType != null) {
//                    Identifier overrideModelLocation = Identifier.fromNamespaceAndPath(blendType.getNamespace(), "blend_type/" + blendType.getPath());
//                    BakedModel overrideModel = Minecraft.getInstance().getModelManager().getModel(ModelIdentifier.standalone(overrideModelLocation));
//
