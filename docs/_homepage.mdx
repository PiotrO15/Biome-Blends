...
1. [Blend definition](./custom-blends/datapack-format.mdx) (data pack), which specifies your blend's behavior.
2. [Blend assets](./custom-blends/resourcepack-format.mdx) (resource pack): the model and the translated name of the blend.
