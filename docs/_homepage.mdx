...
1. [Blend definition](./docs/custom-blends/datapack-format) (data pack), which specifies your blend's behavior.
2. [Blend assets](./docs/custom-blends/resourcepack-format) (resource pack): the model and the translated name of the blend.
3. [Recipe](./docs/custom-blends/blend-recipes) (data pack), which will be used to obtain the blend.